...
import { HorizontalDNAChecker } from "../../../src/chk/horizontalDNAChecker";

/**
 * Uni test for horizontal DNA checker
 */
describe("Horizontal DNA Checker Unit Test", async () => {
  const sut: HorizontalDNAChecker = new HorizontalDNAChecker(4);
